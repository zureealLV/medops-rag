...
MEDICAL_ADVICE = re.compile(
    r"(诊断|确诊|吃什么药|开.{0,6}药|推荐.{0,6}药|给我.{0,6}药|用药|剂量|治疗方案|处方|"
    r"diagnos|dosage|treatment)",
    re.I,
)
SUPPORTED_DOMAIN = re.compile(
    ...
    r"儿童|生长|蛋白|device|oximeter|infusion|UDI|PACS|DICOM|HIS|EMR|LIS|HL7|SSO|Redis|Kafka|NTP|"
